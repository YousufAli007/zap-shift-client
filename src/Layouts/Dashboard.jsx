          ...
          <ul className="menu w-full grow">
            ...
            <li>
              ...
              >
                ...
                <span className="is-drawer-close:hidden">MyParcles</span>
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                className="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                data-tip="PaymentsHistory"
              >
                <FaRegCreditCard size={18} />
                <span className="is-drawer-close:hidden">PaymentsHistory</span>
              </NavLink>
            </li>
           {
            role=='admin' && <li>
              ...
              >
                ...
                <span className="is-drawer-close:hidden">ApproveRaiders</span>
              </NavLink>
            </li>
